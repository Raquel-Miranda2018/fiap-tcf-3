...
if len(sys.argv) < 2:
    print("Uso: python predict.py path_to_input.csv")
    sys.exit(1)
input_csv = sys.argv[1]
df = pd.read_csv(input_csv, low_memory=False)

# exemplo de preprocessing mínimo: extrair hora se colunas existirem
...
out_path = os.path.join(MODEL_DIR, "predictions_from_model.csv")
